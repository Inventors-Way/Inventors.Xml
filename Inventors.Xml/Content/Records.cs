...
namespace Inventors.Xml.Content
{
    ...
    public record ElementDescriptor(string Name, string Type, bool Required, string PropertyName);
    public record EnumValue(string Name, string XSDName, string Documentation);
